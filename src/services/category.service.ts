...
export const updateCategory = async (
  ...
  return dbErrorHandlers.update(
    async () => {
      ...
      const existingCategory = await getCategoryById(categoryId, context);
      if (!existingCategory) {
 ...
 * @param context - Error context for logging
 */
export const deleteCategory = async (categoryId: string, context: ErrorContext = {}): Promise<void> => {
 ...
 */
export const getCategoryById = async (categoryId: string, context: ErrorContext = {}): Promise<Category | null> => {
  return dbErrorHandlers.read(
 ...
 * @returns Promise resolving to category or null if not found
 */
export const getCategoryBySlug = async (slug: string, context: ErrorContext = {}): Promise<Category | null> => {
  return dbErrorHandlers.read(
    async (): Promise<Category | null> => {
 ...
 */
export const getCategoryHierarchy = async (context: ErrorContext = {}): Promise<(Category & { children: Category[] })[]> => {
  return dbErrorHandlers.read(
