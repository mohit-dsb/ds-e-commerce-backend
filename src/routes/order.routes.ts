...
import { createOrderSchema, updateOrderStatusSchema, cancelOrderSchema, confirmPaymentSchema } from "@/db/validators";
...
orderRoutes.patch(
  "/:id/confirm-payment",
  authMiddleware,
  compatibleZValidator("json", confirmPaymentSchema),
